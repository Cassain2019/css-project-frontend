...
function Chat() {
  ...
  return (
    <>
      <div className="nav-header d-print-none">
        <Link to="/" className="brand-logo">
          <img className="logo-abbr" src="images/logo-white.png" alt="LOGO" />
          <img
        ...
        <div
          ...
          onClick={() => {
            setToggle((toggle === "menu-toggle") ? "" : "menu-toggle" );
          }}
        >
      ...
      <div className="chatbox chatSiteBar">
          ...
          <div className="tab-content">
            ...
            >
              ...
              <div className="card chat dz-chat-history-box d-none">
                <div className="card-header chat-list-header text-center">
                  <Link herf="/" className="dz-chat-history-back">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
                      width="18px"
                  ...
                  <div className="dropdown">
                    <Link herf="/" data-toggle="dropdown" aria-expanded={false}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                        width="18px"
                    ...
                    <li className="active">
                      <div className="d-flex bd-highlight">
                        ...
                        <div className="ml-auto">
                          ...
                          <Link herf="/" className="btn btn-danger btn-xs sharp">
